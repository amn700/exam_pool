...
def parse_exercises(file_path):
    """Parse the exam_subs2 file and extract unique exercises."""
    ...
    # Pattern to handle assignment name variations
...
def create_exercise_files(exercises, output_dir="exercises_subs2"):
...
def main():
    input_file = "/workspaces/exam_pool/exam_subs2"
    
    print("Parsing exercises from exam_subs2 file...")
    ...
    print(f"\nSuccessfully created {len(created_files)} exercise files in the 'exercises_subs2' directory!")
